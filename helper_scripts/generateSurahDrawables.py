...
parser = argparse.ArgumentParser(description = "Generate Surah images with optional canvas display.")

# Define the --headless flag. If present, it sets isHeadless to True for batch processing without a window.
parser.add_argument("--headless", action = "store_true", help = "Generate Surah images Headless (without canvas display)")
...
fontPath = os.path.join(f"{projectRootDir}/shared/src/main/res/font/decotype_thuluth_2.ttf")
...
surahs = [
   ...
   "ٱلْفَاتِحَةِ", "ٱلْبَقَرَةِ", "آلِ عِمْرَانَ", "ٱلنِّسَاءِ", "ٱلْمَائِدَةِ", "ٱلْأَنْعَامِ", "ٱلْأَعْرَافِ",
   "ٱلْأَنْفَالِ", "ٱلتَّوْبَةِ", "يُونُسَ", "هُودَ", "يُوسُفَ", "ٱلرَّعْدِ", "إِبْرَاهِيمَ",
   "ٱلْحِجْرِ", "ٱلنَّحْلِ", "ٱلْإِسْرَاءِ", "ٱلْكَهْفِ", "مَرْيَمَ", "طَهَ",
   "ٱلْأَنْبِيَاءِ", "ٱلْحَجِّ", "ٱلْمُؤْمِنُونَ", "ٱلنُّورِ", "ٱلْفُرْقَانِ", "ٱلشُّعَرَاءِ",
   "ٱلنَّمْلِ", "ٱلْقَصَصِ", "ٱلْعَنْكَبُوتِ", "ٱلرُّومِ", "لُقْمَانَ", "ٱلسَّجْدَةِ",
   "ٱلْأَحْزَابِ", "سَبَأٍ", "فَاطِرٍ", "يَس", "ٱلصَّافَّاتِ", "ص",
   "ٱلزُّمَرِ", "غَافِرٍ", "فُصِّلَتْ", "ٱلشُّورَىٰ", "ٱلزُّخْرُفِ", "ٱٱلدُّخَانِ",
   "ٱلْجَاثِيَةِ", "ٱلْأَحْقَافِ", "مُحَمَّدٍ", "ٱلْفَتْحِ", "ٱلْحُجُرَاتِ", "ق",
   "ٱلذَّارِيَاتِ", "ٱلطُّورِ", "ٱلنَّجْمِ", "ٱلْقَمَرِ", "ٱلرَّحْمَٰنِ", "ٱلْوَاقِعَةِ",
   "ٱلْحَدِيدِ", "ٱلْمُجَادِلَةِ", "ٱلْحَشْرِ", "ٱلْمُمْتَحَنَةِ", "ٱلصَّفِّ", "ٱلْجُمُعَةِ",
   "ٱلْمُنَافِقُونَ", "ٱلتَّغَابُنِ", "ٱلطَّلَاقِ", "ٱلْتَّحْرِيمِ", "ٱلْمَلِكِ", "ٱلْقَلَمِ",
   "ٱلْحَاقَّةِ", "ٱلْمَعَارِجِ", "نُوحٍ", "ٱلْجِنِّ", "ٱلْمُزَّمِّلِ", "ٱلْمُدَّثِّرِ",
   "ٱلْقِيَامَةِ", "ٱلْإِنسَانِ", "ٱلْمُرْسَلَاتِ", "ٱلنَّبَأِ", "ٱلنَّازِعَاتِ", "عَبَسَ",
   "ٱلتَّكْوِيرِ", "ٱلْإِنفِطَارِ", "ٱلْمُطَفِّفِينَ", "ٱلْاِنشِقَاقِ", "ٱلْبُرُوجِ", "ٱلطَّارِقِ",
   "ٱلْأَعْلَى", "ٱلْغَاشِيَةِ", "ٱلْفَجْرِ", "ٱلْبَلَدِ", "ٱلشَّمْسِ", "ٱلَّيْلِ",
   "ٱلضُّحَى", "ٱلشَّرْحِ", "ٱلتِّينِ", "ٱلْعَلَقِ", "ٱلْقَدْرِ", "ٱلْبَيْنَةِ",
   "ٱلزَّلْزَلَةِ", "ٱلْعَادِيَاتِ", "ٱلْقَارِعَةِ", "ٱلتَّكَاثُرِ", "ٱلْعَصْرِ", "ٱلْهُمْزَةِ",
   "ٱلْفِيلِ", "قُرَيْشٍ", "ٱلْمَاعُونِ", "ٱلْكَوْثَرِ", "ٱلْكَافِرُونَ", "ٱلنَّصْرِ",
   "ٱلْمَسَدِ", "ٱلْإِخْلَاصِ", "ٱلْفَلَقِ", "ٱلنَّاسِ"
]
...
def drawSurahContent(surahName: str, renderer: RendererType, alpha: int, blur: bool = False) -> None:
   """
...
def setup() -> None:
   ...
   """
   global exporter, fontPath, fontSize, fontSizeSpecial, surahFont, surahFontSpecial, surahIndex
   ...
   if isHeadless:
      ...
      for index in range(len(surahs)):
         ...
         filename = f"{drawablesPath}/surah_{surahIndex:03d}.png" if surahIndex != 0 else f"{drawablesPath}/surah_name.png"
